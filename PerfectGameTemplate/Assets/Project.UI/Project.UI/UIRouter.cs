...
namespace Project.UI {
    ...
    public class UIRouter : UIRouterBase {
        ...
        private async Task LoadMainSceneInternalAsync(CancellationToken cancellationToken) {
            mainSceneHandle = Addressables2.LoadSceneAsync( R.Project.Entities.MainScene.MainScene_, LoadSceneMode.Additive, true );
        ...
        private async Task LoadGameSceneInternalAsync(GameDesc gameDesc, PlayerDesc playerDesc, CancellationToken cancellationToken) {
            gameSceneHandle = Addressables2.LoadSceneAsync( R.Project.Entities.GameScene.GameScene_, LoadSceneMode.Additive, true );
        ...
        private static string GetAddress(GameWorld world) {
            return world switch {
                GameWorld.TestWorld1 => R.Project.Entities.WorldScene.TestWorld_1,
                GameWorld.TestWorld2 => R.Project.Entities.WorldScene.TestWorld_2,
