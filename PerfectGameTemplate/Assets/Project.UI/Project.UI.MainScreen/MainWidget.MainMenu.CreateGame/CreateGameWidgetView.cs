...
namespace Project.UI.MainScreen {
    ...
    public partial class CreateGameWidgetView : UIWidgetViewBase {
        ...
        public class GameView_ : UISubViewBase {
            ...
            // Helpers
            private static VisualElement CreateVisualElement(out Label title, out TextField gameName, out PopupField<GameMode> gameMode, out PopupField<GameWorld> gameWorld, out Toggle isGamePrivate) {
