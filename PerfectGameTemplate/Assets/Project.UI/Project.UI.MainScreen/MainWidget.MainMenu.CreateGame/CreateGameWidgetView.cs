...
namespace Project.UI.MainScreen {
    ...
    public partial class CreateGameWidgetView : UIWidgetViewBase {
        ...
        public class GameView_ : UISubViewBase {
            ...
            // Helpers
            private static VisualElement CreateVisualElement(out Label title, out TextField gameName, out PopupField<object?> gameMode, out PopupField<object?> gameWorld, out Toggle isGamePrivate) {
        ...
        public class PlayerView_ : UISubViewBase {
            ...
            // Helpers
            private static ColumnGroup CreateVisualElement(out Label title, out TextField playerName, out PopupField<object?> playerRole) {
                return UIFactory.ColumnGroup().Classes( "light5", "medium", "grow-1" ).Children(
