...
namespace Project.UI.GameScreen {
    ...
    public class GameTheme : UIAudioTheme2 {
        ...
        public new void Awake() {
            ...
            Themes = Shuffle( Addressables2.LoadAssetsAsync<AudioClip>( R.Project.UI.GameScreen.Music.Theme_1, R.Project.UI.GameScreen.Music.Theme_2, R.Project.UI.GameScreen.Music.Theme_3 ).GetResult()! );
        }
