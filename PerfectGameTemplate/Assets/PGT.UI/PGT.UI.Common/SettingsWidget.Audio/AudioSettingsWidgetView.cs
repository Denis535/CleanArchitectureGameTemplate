...
namespace PGT.UI.Common {
    ...
    public partial class AudioSettingsWidgetView {
        ...
        public record SubmitCommand() : UICommand<AudioSettingsWidgetView>;
        public record CancelCommand() : UICommand<AudioSettingsWidgetView>;
    }
    public partial class AudioSettingsWidgetView : UIWidgetView2 {
        ...
        public ValueMinMaxWrapper<float> MasterVolume => masterVolume;
        public ValueMinMaxWrapper<float> MusicVolume => musicVolume;
        public ValueMinMaxWrapper<float> SfxVolume => sfxVolume;
        public ValueMinMaxWrapper<float> GameVolume => gameVolume;
