...
namespace PGT.UI {
    ...
    public abstract class UIScreenView2 : UIScreenView {
        ...
        // ShowView
        private void ShowView(UIWidgetView view, UIWidgetView? shadowed) {
            shadowed?.SaveFocus();
            if (!view.IsModal()) {
        ...
        private void HideView(UIWidgetView view, UIWidgetView? unshadowed) {
            if (!view.IsModal()) {
        ...
        // Helpers
        private static bool IsConfirm(Button button) {
            return button.name is "confirm" or "confirmation" or "yes" or "ok" or "okey";
        }
        private static bool IsCancel(Button button) {
            return button.name is "cancel" or "cancellation" or "no" or "back";
        }
        // Helpers
        private static void PlayWindowAnimation(UIWidgetView view) {
