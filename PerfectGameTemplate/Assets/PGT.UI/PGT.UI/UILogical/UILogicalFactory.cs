namespace PGT.UI {
    ...
    public static class UILogicalFactory {
        ...
        public static CreateGameWidget2 CreateGameWidget2(CreateGameWidget createGameWidget) {
            return new CreateGameWidget2( createGameWidget );
        }
        public static JoinGameWidget JoinGameWidget() {
            return new JoinGameWidget();
        }
        public static JoinGameWidget2 JoinGameWidget2(JoinGameWidget joinGameWidget) {
            return new JoinGameWidget2( joinGameWidget );
        }
