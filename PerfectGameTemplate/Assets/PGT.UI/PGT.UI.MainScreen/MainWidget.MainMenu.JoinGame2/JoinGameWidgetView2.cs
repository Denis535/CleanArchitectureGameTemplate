...
namespace PGT.UI.MainScreen {
    ...
    public partial class JoinGameWidgetView2 {
        [Preserve]
        public new class UxmlFactory : UxmlFactory<JoinGameWidgetView2, UxmlTraits> { }
        public record OkeyCommand() : UICommand<JoinGameWidgetView2>;
        public record BackCommand() : UICommand<JoinGameWidgetView2>;
        public record SubmitCommand() : UICommand<JoinGameWidgetView2>;
        public record CancelCommand() : UICommand<JoinGameWidgetView2>;
    }
    public partial class JoinGameWidgetView2 : UIWidgetView2 {
