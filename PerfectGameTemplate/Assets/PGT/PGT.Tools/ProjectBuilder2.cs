...
namespace PGT.Tools {
    ...
    public class ProjectBuilder2 : ProjectBuilder {
        ...
        public override void PreBuild() {
            new AssetsSourceGenerator().Generate( "Assets/PGT.Core/UnityEngine/R.cs", "UnityEngine", "R", AddressableAssetSettingsDefaultObject.Settings );
            new LabelsSourceGenerator().Generate( "Assets/PGT.Core/UnityEngine/L.cs", "UnityEngine", "L", AddressableAssetSettingsDefaultObject.Settings );
