...
namespace UnityEngine.UIElements {
    ...
    public class DropdownField2<T> : PopupField<T> {

        public static Func<T, string>? Formatter { get; set; }
        ...
        public DropdownField2(string? label, int index, T[] choices) {
            if (Formatter != null) {
                formatSelectedValueCallback = Formatter;
                formatListItemCallback = Formatter;
            }
        ...
        public DropdownField2(string? label, T value, T[] choices) {
            if (Formatter != null) {
                formatSelectedValueCallback = Formatter;
                formatListItemCallback = Formatter;
            }
