...
namespace UnityEngine.Framework.UI {
    ...
    public static class VisualElementWrapperExtensions {
        ...
        public static SliderWrapper<T> Wrap<T>(this BaseSlider<T> target) where T : struct, IComparable<T> {
    ...
    // Popup
    public class PopupWrapper2<T> : VisualElementWrapper<PopupField<object?>> {
